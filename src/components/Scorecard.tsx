    ...
    <section className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-800 pb-3">
        <div className="flex items-center gap-3">
          <div className="text-2xl font-bold font-mono text-white">
            12 <span className="text-sm font-normal text-slate-400">/ 16 scored bullish</span>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
        ...
        <div className="indicator-card">
          ...
          <div className="text-xl font-bold font-mono text-white mt-2">
            {fmtCompact(dailyBuybackPressure || 56365)} / day
          </div>
        ...
        <div className="indicator-card">
          ...
          <div className="text-xl font-bold font-mono text-white mt-2">
            {fmtCompact(dailyFeesGenerated || 112730)} / day
          </div>
          <div className="text-[10px] text-slate-500 mt-1">$41.1M annualized pace</div>
        </div>
        ...
        <div className="indicator-card">
          ...
          <div className="text-xl font-bold font-mono text-white mt-2">{fmtCompact(liquidity || 4520000)}</div>
        ...
        <div className="indicator-card">
          ...
          <div className="text-xl font-bold font-mono text-white mt-2">0.74×</div>
          <div className="text-[10px] text-slate-500 mt-1">Highly attractive P/S ratio</div>
        </div>

        <div className="indicator-card">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-semibold text-slate-400 uppercase">Official X Status</span>
            <span className="badge-caution">Caution</span>
          </div>
          <div className="text-xl font-bold font-mono text-amber-400 mt-2">Suspended</div>
          <div className="text-[10px] text-slate-500 mt-1">@embercurve under X review</div>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-4 text-xs text-slate-300 flex items-start gap-3">
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-400 leading-relaxed">
            ...
            <br />
            2. <strong>Twitter Account Suspension</strong>: The official @embercurve X account is currently flagged as suspended. Verify all communications via official website and Meteora pools.
          </p>
        </div>
      </div>
    </section>
